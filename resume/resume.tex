...
\urlstyle{same}\url{http://stackoverflow.com/users/2615252} \\ }{Availability: March - June 2017}
...
\location{January 2016 – March 2017 | Boston, MA}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize} \item Work as a full-stack developer on web, server, and iOS products. \item Develop in AngularJS, Node.js, Swift, and Mongoose. \item Built the curated lists module for the company's admin portal. \item Built, and took ownership of a repository of Jinja templates and Python scripts for managing email distribution for Tablelist projects.  \item Refactored server notification code to work with the new templates and service; Built opensource python package to interface with sendwithus: \underline{Github://\href{https://github.com/SwankSwashbucklers/uploadwithus}{ uploadwithus}}  \item Added tiered-ticketing to NightPro, the company's venue management app. \end{tightemize}
\sectionsep
...
\begin{tightemize} \item Create mobile applications for clients, and applications for distribution under the company developer account. \item Develop mobile applications using both native iOS development (i.e. Swift, Objective-C, Core Data, Interface Builder, and Size Classes), and cross-platform development (i.e. Phonegap, Javascript, AngularJS, CSS, and HTML) \item Completed and released an iOS password and account manager called passKey, which is out on the Apple app store today.\item Acquire experience running and maintaining a business. \item Created a company website: \underline{\href{http://appswithstyle.net}{http://appswithstyle.net}}, for showcasing applications and company information. \end{tightemize}
\sectionsep

\runsubsection{bottle-builder}
\descript{| Github:// \href{https://github.com/SwankSwashbucklers/bottle-builder}{\bf bottle-builder}}
\fontspec[Path = fonts/raleway/]{Raleway-Medium}\fontsize{10pt}{12pt}\selectfont {} \normalfont
\begin{tightemize} \item A python package containing a build tool for bottle web projects. \item Complete with favicon, opengraph, head, and app route generation. \end{tightemize}
\sectionsep
